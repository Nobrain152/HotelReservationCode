...
public class PromotionHotelControllerTest {
	...
	public void setUp() throws Exception {
		hotel1 = new PromotionHotelPO("七天",PromotionHotelType.BIRTH_PROMOTION,"vip", null, null, "80%");
		hotel2 = new PromotionHotelPO("七天",PromotionHotelType.OVERTHREE_PROMOTION,"vip", null, null, "70%");
		hotel3 = new PromotionHotelPO("七天",PromotionHotelType.HOTEL_CUSTOM_PROMOTION,"vip","2016/11/05", "2016/11/11", "50%");
		//hotel要添加增加方法
